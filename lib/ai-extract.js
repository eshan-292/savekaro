...
const PARAMETER_GROUPS = {
  'iron_studies': {
    ...
    expect: ['iron', 'tibc', 'uibc', 'ferritin', 'iron_saturation'],    // we expect all of these
  ...
  'lipid': {
    ...
    names: ['Total Cholesterol', 'LDL', 'HDL Cholesterol', 'Triglycerides', 'VLDL', 'Non-HDL Cholesterol', 'LDL/HDL Ratio']
  },
  'thyroid': {
