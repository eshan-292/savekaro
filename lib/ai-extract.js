...
EXTRACTION COMPLETENESS — Extract EVERY parameter including:
- Complete CBC: Hemoglobin, RBC, WBC, Platelets, Hematocrit, MCV, MCH, MCHC, RDW-CV, RDW-SD
- WBC Differential (BOTH % AND absolute): Neutrophils, Lymphocytes, Monocytes, Eosinophils, Basophils
- Lipid Profile: Total Cholesterol, LDL, HDL, Triglycerides, VLDL, ratios
- Liver Function: SGOT/AST, SGPT/ALT, ALP, Bilirubin (Total, Direct, Indirect), Total Protein, Albumin, Globulin, A/G Ratio, GGT
- Kidney Function: BUN, Serum Urea, Creatinine, Uric Acid, eGFR
- Thyroid: TSH, Total T3, Free T3, Total T4, Free T4
- Iron Studies: Serum Iron, TIBC, Ferritin, Iron Saturation/Transferrin Saturation, UIBC
- Diabetes: Fasting Glucose, HbA1c, Post Prandial Glucose, Fasting Insulin
- Vitamins: Vitamin D, Vitamin B12, Folate/Folic Acid, Calcium
- Urine: pH, Specific Gravity, Protein, Glucose, etc. (if present)
- Any other test parameters present in the report
