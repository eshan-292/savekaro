...
const CLINICAL_PATTERNS = [
  ...
  },
  {
    ...
    minMatches: 2,
    // Don't fire this pattern if iron_deficiency or b12_deficiency already detected (they're more specific)
    suppressedByPatterns: ['iron_deficiency', 'b12_deficiency'],
    recommendations: [
